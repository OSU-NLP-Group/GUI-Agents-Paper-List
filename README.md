...
<p align="center">
  <a href="https://osu-nlp-group.github.io/GUI-Agents-Paper-List/">
    <img alt="Browse the website" src="https://img.shields.io/badge/%E2%9C%A6%20Browse%20the%20website-osu--nlp--group.github.io%2FGUI--Agents--Paper--List-3057c4?style=for-the-badge&labelColor=23211c">
  </a>
</p>
...
### 🌐 [The website is the recommended way to read this list →](https://osu-nlp-group.github.io/GUI-Agents-Paper-List/)

It's a free, fast static site generated from the markdown files in this repo.<br>
What you get over the raw markdown:

| | |
| :-- | :-- |
| 🔎  | **Full-text search** across titles, authors, institutions, TLDRs, keywords |
| 🎚  | **Multi-axis filtering** — environment, keyword (AND/OR), author, institution, year, venue, with shareable URLs |
| 🧾  | **Per-paper detail pages** with the full TLDR, all keywords, related papers, BibTeX |
| 📋  | **One-click BibTeX copy** — LaTeX-paste-ready, with `@misc` for arXiv-only and `@inproceedings` / `@article` otherwise (auto-generated; please verify before citing) |
| 📈  | **Interactive stats** — quarterly publication trend by environment, top keywords / institutions / authors / venues |
| 🌓  | Warm-paper light + dark theme, keyboard-friendly, no tracking |

</td></tr>
</table>

The markdown files in this repo remain the source of truth — every link, tag, and TLDR on the website is generated from `ALL_PAPERS.md`.
