...
| [Web (178)](paper_by_env/paper_web.md) | [Desktop (85)](paper_by_env/paper_desktop.md) | [Mobile (125)](paper_by_env/paper_mobile.md) | [GUI (145)](paper_by_env/paper_gui.md) | [Search (3)](paper_by_env/paper_search.md) | [Misc (16)](paper_by_env/paper_misc.md) |
|---|---|---|---|---|---|

(Misc: Papers for general topics that have important applications in GUI agents.)

## Papers Grouped by Keywords
[benchmark (203)](paper_by_key/paper_benchmark.md) | [framework (184)](paper_by_key/paper_framework.md) | [dataset (109)](paper_by_key/paper_dataset.md) | [reinforcement learning (78)](paper_by_key/paper_reinforcement_learning.md) | [model (57)](paper_by_key/paper_model.md) | [GUI grounding (45)](paper_by_key/paper_GUI_grounding.md) | [safety (41)](paper_by_key/paper_safety.md) | [evaluation (39)](paper_by_key/paper_evaluation.md) | [security (27)](paper_by_key/paper_security.md) | [planning (25)](paper_by_key/paper_planning.md) | [LLM agent (20)](paper_by_key/paper_LLM_agent.md) | [WebArena (17)](paper_by_key/paper_WebArena.md) | [visual grounding (15)](paper_by_key/paper_visual_grounding.md) | [memory (15)](paper_by_key/paper_memory.md) | [survey (14)](paper_by_key/paper_survey.md) | [OSWorld (14)](paper_by_key/paper_OSWorld.md) | [reasoning (14)](paper_by_key/paper_reasoning.md) | [attack (14)](paper_by_key/paper_attack.md) | [mobile GUI agent (14)](paper_by_key/paper_mobile_GUI_agent.md) | [grounding (12)](paper_by_key/paper_grounding.md)

## Papers Grouped by Authors
[Yu Su (18)](paper_by_author/paper_Yu_Su.md) | [Huan Sun (15)](paper_by_author/paper_Huan_Sun.md) | [Graham Neubig (13)](paper_by_author/paper_Graham_Neubig.md) | [Tao Yu (13)](paper_by_author/paper_Tao_Yu.md) | [Caiming Xiong (11)](paper_by_author/paper_Caiming_Xiong.md) | [Shuyan Zhou (10)](paper_by_author/paper_Shuyan_Zhou.md) | [Wei Liu (10)](paper_by_author/paper_Wei_Liu.md) | [Jian Luan (10)](paper_by_author/paper_Jian_Luan.md) | [Mike Zheng Shou (10)](paper_by_author/paper_Mike_Zheng_Shou.md) | [Zhuosheng Zhang (10)](paper_by_author/paper_Zhuosheng_Zhang.md) | [Boyuan Zheng (10)](paper_by_author/paper_Boyuan_Zheng.md) | [Jie Tang (9)](paper_by_author/paper_Jie_Tang.md) | [Yuanchun Li (9)](paper_by_author/paper_Yuanchun_Li.md) | [Jun Wang (9)](paper_by_author/paper_Jun_Wang.md) | [Tianbao Xie (9)](paper_by_author/paper_Tianbao_Xie.md) | [Yuxiang Chai (8)](paper_by_author/paper_Yuxiang_Chai.md) | [Kun Shao (8)](paper_by_author/paper_Kun_Shao.md) | [Jianye Hao (8)](paper_by_author/paper_Jianye_Hao.md) | [Zeyi Liao (8)](paper_by_author/paper_Zeyi_Liao.md) | [Qiushi Sun (8)](paper_by_author/paper_Qiushi_Sun.md)
...
- [UI-Voyager: A Self-Evolving GUI Agent Learning via Failed Experience](https://arxiv.org/abs/2603.24533)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [model], [reinforcement learning], [self-evolving], [failed trajectory learning], [RFT], [GRSD], [AndroidWorld], [UI-Voyager]
    - 📖 TLDR: UI-Voyager is a self-evolving mobile agent that learns from failed trajectories instead of relying on manual annotations. Its two-stage design combines rejection fine-tuning with group-relative self-distillation to turn successful rollouts into dense corrective supervision, yielding strong AndroidWorld performance from a 4B model.
...
- [Ego2Web: A Web Agent Benchmark Grounded in Egocentric Videos](https://arxiv.org/abs/2603.22529)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [benchmark], [egocentric video], [multimodal agent], [Ego2Web], [LLM-as-a-judge]
...
- [OS-Themis: A Scalable Critic Framework for Generalist GUI Rewards](https://arxiv.org/abs/2603.19191)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [reward model], [reinforcement learning], [benchmark], [multi-agent framework], [evaluation]
...
- [WebPII: Benchmarking Visual PII Detection for Computer-Use Agents](https://arxiv.org/abs/2603.17357)
    ...
    - 📖 TLDR: WebPII is a benchmark for detecting personally identifiable information in web screenshots, focusing on e-commerce interfaces where agents may expose sensitive content during browsing and form completion. It expands the PII taxonomy to transaction-level identifiers and partially filled forms, and pairs the benchmark with WebRedact to show practical privacy-preserving utility.
...
- [AdaZoom-GUI: Adaptive Zoom-based GUI Grounding with Instruction Refinement](https://arxiv.org/abs/2603.17441)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [model], [GUI grounding], [instruction refinement], [adaptive zoom], [GRPO], [AdaZoom-GUI]
...
- [GUI-CEval: A Hierarchical and Comprehensive Chinese Benchmark for Mobile GUI Agents](https://arxiv.org/abs/2603.15039)
    ...
    - 🏛️ Institutions: HyperAI Team, Xiaomi Corporation
    - 📅 Date: March 16, 2026
    - 📑 Publisher: CVPR 2026
    - 💻 Env: [Mobile]
    - 🔑 Key: [benchmark], [chinese], [evaluation], [GUI grounding], [agent]
...
- [Adaptive Vision-Language Model Routing for Computer Use Agents](https://arxiv.org/abs/2603.12823)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [framework], [VLM routing], [cost-accuracy tradeoff], [semantic routing], [OpenClaw], [AVR]
    - 📖 TLDR: AVR adds a semantic routing layer that decides which vision-language model should handle each GUI action based on predicted difficulty, confidence, and a target reliability threshold. It frames model selection as a cost-accuracy tradeoff and shows that many actions can be handled by cheaper models without sacrificing much grounding quality.
...
- [Safe and Scalable Web Agent Learning via Recreated Websites](https://arxiv.org/abs/2603.10505)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [framework], [training environment], [VeriEnv], [synthetic environment], [reinforcement learning]
...
- [OpenClaw-RL: Train Any Agent Simply by Talking](https://arxiv.org/abs/2603.10165)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [reinforcement learning], [agent training], [next-state signals], [process reward model], [hindsight distillation], [OpenClaw-RL]
    - 📖 TLDR: OpenClaw-RL is an asynchronous RL framework that treats next-state signals from live interactions as a universal training source, using reward extraction and hindsight-guided distillation to train agents across GUI, terminal, SWE, and tool-use settings in one online loop.
...
- [SpecOps: A Fully Automated AI Agent Testing Framework in Real-World GUI Environments](https://arxiv.org/abs/2603.10268)
    ...
    - 📑 Publisher: ICSE 2026
    - 💻 Env: [GUI]
    - 🔑 Key: [framework], [testing], [bug finding], [specialist agents], [real-world evaluation], [SpecOps]
    - 📖 TLDR: SpecOps is a fully automated testing framework for real-world GUI agents that splits testing into specialized phases for case generation, environment setup, execution, and validation. It finds 164 true bugs across five deployed agents while keeping cost and runtime practical enough for repeated large-scale testing.
...
- [Generalization in Online Reinforcement Learning for Mobile Agents](https://arxiv.org/abs/2603.07432)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [reinforcement learning], [benchmark], [generalization], [Android]
...
- [WebFactory: Automated Compression of Foundational Language Intelligence into Grounded Web Agents](https://arxiv.org/abs/2603.05044)
    - Sicheng Fan, Qingyun Shi, Shengze Xu, Shengbo Cai, Tieyong Zeng
    - 🏛️ Institutions: Fudan University, IMean AI, The Chinese University of Hong Kong, Tsinghua University
    - 📅 Date: March 05, 2026
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [reinforcement learning], [synthetic data], [environment synthesis], [knowledge distillation]
...
- [TimeWarp: Evaluating Web Agents by Revisiting the Past](https://arxiv.org/abs/2603.04949)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [benchmark], [TimeWarp], [TimeTraj], [behavior cloning], [plan distillation]
...
- [K²-Agent: Co-Evolving Know-What and Know-How for Hierarchical Mobile Device Control](https://arxiv.org/abs/2603.00676)
    ...
    - 💻 Env: [Mobile]
    - 🔑 Key: [framework], [hierarchical control], [declarative knowledge], [procedural knowledge], [SRLR], [C-GRPO], [K²-Agent]
    - 📖 TLDR: Separates mobile device control into a high-level "know-what" reasoner and a low-level "know-how" executor, then co-evolves both parts during training. The SRLR loop refines declarative task knowledge, while curriculum-guided GRPO trains procedural execution, yielding 76.1% on AndroidWorld and strong transfer to ScreenSpot-v2 and AITW.
...
- [M^2: Dual-Memory Augmentation for Long-Horizon Web Agents via Trajectory Summarization and Insight Retrieval](https://arxiv.org/abs/2603.00503)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [framework], [memory augmentation], [trajectory summarization], [insight retrieval], [long-horizon tasks]
...
- [GUI-Libra: Training Native GUI Agents to Reason and Act with Action-aware Supervision and Partially Verifiable RL](https://arxiv.org/abs/2602.22190)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [training], [reinforcement learning], [dataset]
...
- [Modeling Distinct Human Interaction in Web Agents](https://arxiv.org/abs/2602.17588)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [dataset], [framework], [human-agent interaction], [intervention prediction], [CowCorpus]
    - 📖 TLDR: Studies collaborative web agents through the lens of human intervention, collecting CowCorpus with 400 real-user web trajectories that interleave human and agent actions. The paper identifies four recurring interaction styles and shows that modeling them improves intervention prediction by 61.4-63.4% and increases user-rated usefulness by 26.5% in live agents.
...
- [World-Model-Augmented Web Agents with Action Correction](https://arxiv.org/abs/2602.15384)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [framework], [world model], [WAC], [multi-agent collaboration], [action correction]
...
- [EmbeWebAgent: Embedding Web Agents into Any Customized UI](https://arxiv.org/abs/2602.14865)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [framework], [enterprise], [ARIA], [MCP]
...
- [WebWorld: A Large-Scale World Model for Web Agent Training](https://arxiv.org/abs/2602.14721)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [world model], [data generation], [benchmark], [training], [environment simulation]
...
- [GUI-GENESIS: Automated Synthesis of Efficient Environments with Verifiable Rewards for GUI Agent Post-Training](https://arxiv.org/abs/2602.14093)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [reinforcement learning], [environment synthesis], [verifiable reward], [training efficiency]
...
- [Moving Beyond Sparse Grounding with Complete Screen Parsing Supervision](https://arxiv.org/abs/2602.14276)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [GUI grounding], [dataset], [screen parsing], [UI understanding]
...
- [Building Autonomous GUI Navigation via Agentic-Q Estimation and Step-Wise Policy Optimization](https://arxiv.org/abs/2602.13653)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [reinforcement learning], [q-value estimation], [policy optimization], [MLLM], [web navigation]
    - 📖 TLDR: This paper proposes a GUI-agent training framework built around an agentic-Q model that scores the contribution of individual actions to task completion and a step-wise policy optimization procedure decoupled from online environment interaction. The design keeps data collection manageable while stabilizing policy updates, and the resulting system gives Ovis2.5-9B strong navigation and grounding performance.
...
- [WebClipper: Efficient Evolution of Web Agents with Graph-based Trajectory Pruning](https://arxiv.org/abs/2602.12852)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [framework], [trajectory pruning], [graph-based optimization], [WebClipper], [training efficiency]
    - 📖 TLDR: WebClipper represents web-agent search traces as state graphs and prunes them by mining a minimum-necessary DAG that preserves useful reasoning while removing loops and unproductive branches. Training on these refined trajectories improves accuracy while cutting tool-call rounds by about 20%, and the paper introduces F-AE Score to evaluate the resulting accuracy-efficiency balance.
...
- [Scaling Web Agent Training through Automatic Data Generation and Fine-grained Evaluation](https://arxiv.org/abs/2602.12544)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [framework], [data generation], [fine-grained evaluation], [BookingArena], [knowledge distillation]
    - 📖 TLDR: This paper builds a scalable web-agent training pipeline around a constraint-based evaluator that measures partial progress toward task completion, making partially successful trajectories usable for training instead of discarding them. It also introduces BookingArena, a benchmark of complex booking tasks across 20 websites, and shows that a distilled smaller model can match or exceed much larger commercial systems.
...
- [Adaptive Milestone Reward for GUI Agents](https://arxiv.org/abs/2602.11524)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [reinforcement learning], [reward shaping], [credit assignment], [AndroidWorld]
    - 📖 TLDR: ADMIRE is a reward mechanism for GUI-agent reinforcement learning that replaces the sparse-vs-biased reward trade-off with adaptive, verifiable milestones distilled from successful trajectories. It pairs milestone rewards with asymmetric credit assignment for successful and failed rollouts, delivering more than 10% absolute gains on AndroidWorld and transferring to other RL algorithms and environments.
...
- [Agentic Test-Time Scaling for WebAgents](https://arxiv.org/abs/2602.12276)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [framework], [test-time scaling], [CATTS], [inference-time compute], [uncertainty estimation]
...
- [See, Plan, Snap: Evaluating Multimodal GUI Agents in Scratch](https://arxiv.org/abs/2602.10814)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [benchmark], [scratch], [drag-and-drop], [multimodal agent], [evaluation]
...
- [Blind Gods and Broken Screens: Architecting a Secure, Intent-Centric Mobile Agent Operating System](https://arxiv.org/abs/2602.10915)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [agent security], [prompt injection], [access control], [operating system], [benchmark]
...
- [Code2World: A GUI World Model via Renderable Code Generation](https://arxiv.org/abs/2602.09856)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [world model], [code generation], [reinforcement learning], [Android], [VLM]
...
- [Avenir-Web: Human-Experience-Imitating Multimodal Web Agents with Mixture of Grounding Experts](https://arxiv.org/abs/2602.02468)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [framework], [avenir-web], [mixture of grounding experts], [multimodal LLM], [online-Mind2Web]
...
- [Where Not to Learn: Prior-Aligned Training with Subset-based Attribution Constraints for Reliable Decision-Making](https://arxiv.org/abs/2602.07008)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [training], [attribution], [explainability], [MLLM], [reliability]
...
- [Darwinian Memory: A Training-Free Self-Regulating Memory System for GUI Agent Evolution](https://arxiv.org/abs/2601.22528)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [memory system], [training-free], [MLLM], [multi-app]
...
- [WebArbiter: A Principle-Guided Reasoning Process Reward Model for Web Agents](https://arxiv.org/abs/2601.21872)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [model], [reward model], [process reward model], [reasoning verifier], [WebArbiter]
    - 📖 TLDR: WebArbiter is a process reward model for web agents that treats reward modeling as structured text generation: it produces principle-guided justifications, a preference verdict, and the action most conducive to task completion under the current context. On WebPRMBench and reward-guided trajectory search, it outperforms prior web PRMs and shows that compact specialized verifiers can improve both training and inference-time selection.
...
- [Continual GUI Agents](https://arxiv.org/abs/2601.20732)
    ...
    - 📖 TLDR: Defines continual GUI agents as a setting where domain and resolution shift over time, causing static GUI policies to lose grounding stability. The proposed GUI-AiF reinforcement fine-tuning method uses anchoring-point and anchoring-region rewards to stay aligned with shifting targets, outperforming prior baselines and turning continual adaptation into an explicit GUI-agent training problem.
...
- [OmegaUse: Building a General-Purpose GUI Agent for Autonomous Task Execution](https://arxiv.org/abs/2601.20380)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [model], [synthetic data], [Mixture-of-Experts], [GRPO], [OS-Nav], [OmegaUse]
    - 📖 TLDR: Builds a general-purpose GUI agent for both phone-use and computer-use settings using a curated-plus-synthetic data pipeline and a two-stage SFT-then-GRPO training recipe on an MoE backbone. The paper also introduces the OS-Nav benchmark suite and reports strong results across cross-terminal grounding and action benchmarks, including ScreenSpot-v2, AndroidControl, ChiM-Nav, and Ubu-Nav.
...
- [MAGNET: Towards Adaptive GUI Agents with Memory-Driven Knowledge Evolution](https://arxiv.org/abs/2601.19199)
    ...
    - 🏛️ Institutions: Fudan University, University of Southern California, Shanghai Innovation Institute
    - 📅 Date: January 27, 2026
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [memory], [Android], [knowledge transfer], [adaptation]
...
- [SwipeGen: Bridging the Execution Gap in GUI Agents via Human-like Swipe Synthesis](https://arxiv.org/abs/2601.18305)
    ...
    - 🏛️ Institutions: College of Computer Science and Artificial Intelligence, Fudan University, Shanghai Key Laboratory of Intelligent Information Processing, China
    - 📅 Date: January 26, 2026
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [swipe interaction], [data synthesis], [benchmark], [action execution]
...
- [LongHorizonUI: A Unified Framework for Robust long-horizon Task Automation of GUI Agent](https://openreview.net/forum?id=BK7Mk5d4WE)
    ...
    - 🏛️ Institutions: Chengdu Institute of Computer Applications, Chinese Academy of Sciences, University of Chinese Academy of Sciences, Tencent Turing Lab, Georgia Institute of Technology, Tsinghua University
    - 📅 Date: January 26, 2026
    - 📑 Publisher: ICLR 2026 (Poster)
    - 💻 Env: [GUI]
...
- [ScienceBoard: Evaluating Multimodal Autonomous Agents in Realistic Scientific Workflows](https://openreview.net/forum?id=bJvwJahJeF)
    ...
    - 📖 TLDR: ScienceBoard is a realistic multimodal environment and benchmark with 169 tasks across six scientific domains for evaluating agents that operate GUI and CLI workflows. Current agents achieve only about 15% success, exposing major gaps in visual grounding and domain reasoning for scientific work.

- [GAIA: A Data Flywheel System for Training GUI Test-Time Scaling Critic Models](https://arxiv.org/abs/2601.18197)
    - Shaokang Wang, Pei Fu, Ruoceng Zhang, Shaojie Zhang, Xiuwen Xi
    - 🏛️ Institutions: MiLM Plus, Xiaomi Inc
    - 📅 Date: January 26, 2026
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [test-time scaling], [critic model], [data flywheel], [training framework]
...
- [EntWorld: A Holistic Environment and Benchmark for Verifiable Enterprise GUI Agents](https://arxiv.org/abs/2601.17722)
    - Ying Mo, Yu Bai, Dapeng Sun, Yuqian Shi, Yukai Miao, Li Chen
    - 🏛️ Institutions: Zhongguancun Laboratory, Tsinghua University
    - 📅 Date: January 25, 2026
    - 📑 Publisher: arXiv
    - 💻 Env: [Desktop]
    - 🔑 Key: [benchmark], [enterprise], [evaluation], [dataset]
...
- [GraphPilot: GUI Task Automation with One-Step LLM Reasoning Powered by Knowledge Graph](https://arxiv.org/abs/2601.17418)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [knowledge graph], [LLM], [task automation], [efficiency]
...
- [The Behavioral Fabric of LLM-Powered GUI Agents: Human Values and Interaction Outcomes](https://arxiv.org/abs/2601.16356)
    - Simret Araya Gebreegziabher, Yukun Yang, Charles Chiang, Hojun Yoo, Chaoran Chen, Hyo Jin Do
    - 🏛️ Institutions: University of Notre Dame, IBM Research
    - 📅 Date: January 22, 2026
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [benchmark], [alignment], [human values], [persona], [empirical study]
...
- [MagicGUI-RMS: A Multi-Agent Reward Model System for Self-Evolving GUI Agents via Automated Feedback Reflux](https://arxiv.org/abs/2601.13060)
    - Zecheng Li, Zhihui Cao, Wenke Huang, Yudong Zhang, Keying Qi, Rui Wang
    - 🏛️ Institutions: Honor Device Co., Ltd.
    - 📅 Date: January 19, 2026
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [reward model], [multi-agent system], [self-evolving], [reinforcement learning], [data construction]
...
- [PersonalAlign: Hierarchical Implicit Intent Alignment for Personalized GUI Agent with Long-Term User-Centric Records](https://arxiv.org/abs/2601.09636)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [personalization], [implicit intent], [benchmark], [user preference], [proactive assistance]
...
- [ColorBrowserAgent: Complex Long-Horizon Browser Agent with Adaptive Knowledge Evolution](https://arxiv.org/abs/2601.07262)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [knowledge evolution], [human-in-the-loop], [long-horizon tasks], [WebArena], [memory management]
...
- [GUITester: Enabling GUI Agents for Exploratory Defect Discovery](https://arxiv.org/abs/2601.04500)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [GUI testing], [multi-agent], [benchmark], [defect detection], [MLLM]
...
- [Agent-Dice: Disentangling Knowledge Updates via Geometric Consensus for Agent Continual Learning](https://arxiv.org/abs/2601.03641)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [GUI]
    - 🔑 Key: [continual learning], [parameter fusion], [catastrophic forgetting], [LLM agent], [tool-use agent]
...
- [WebGym: Scaling Training Environments for Visual Web Agents with Realistic Tasks](https://arxiv.org/abs/2601.02439)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [training environment], [reinforcement learning], [vision-language model], [benchmark], [open-source]
...
- [SmartSnap: Proactive Evidence Seeking for Self-Verifying Agents](https://arxiv.org/abs/2512.22322)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [reinforcement learning], [self-verification], [evidence seeking], [mobile GUI agent], [LLM-as-a-judge], [AndroidLab]
...
- [AndroidLens: Long-latency Evaluation with Nested Sub-targets for Android GUI Agents](https://arxiv.org/abs/2512.21302)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [Android], [benchmark], [evaluation], [GUI testing]
...
- [MobileWorld: Benchmarking Autonomous Mobile Agents in Agent-User Interactive and MCP-Augmented Environments](https://arxiv.org/abs/2512.19432)
    ...
    - 🏛️ Institutions: Tongyi Lab, Alibaba Group, The Hong Kong University of Science and Technology (Guangzhou), University of Florida
    - 📅 Date: December 22, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [benchmark], [agent-user interaction], [MCP], [cross-app tasks], [planner-executor framework], [MobileWorld]
    - 📖 TLDR: MobileWorld is a mobile-agent benchmark that extends AndroidWorld with longer cross-app tasks, explicit agent-user interaction, and MCP-augmented workflows. Its 201 tasks across 20 apps expose major weaknesses in clarification, tool integration, memory, and long-horizon coordination, with current end-to-end agents still far below reliable performance.
...
- [EchoTrail-GUI: Building Actionable Memory for GUI Agents via Critic-Guided Self-Exploration](https://arxiv.org/abs/2512.19396)
    ...
    - 🏛️ Institutions: School of Computer Science and Technology, East China Normal University, Alibaba Group, Shanghai Innovation Institute
    - 📅 Date: December 22, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [memory-augmented agent], [trajectory retrieval], [Android automation], [in-context learning], [self-exploration]
...
- [DAVE: A VLM Vision Encoder for Document Understanding and Web Agents](https://arxiv.org/abs/2512.17221)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [vision encoder], [document understanding], [VLM], [web localization], [self-supervised learning]
...
- [Using GUI Agent for Electronic Design Automation](https://arxiv.org/abs/2512.11611)
    ...
    - 🏛️ Institutions: College of Computing and Data Science, Nanyang Technological University, Center of AI Evaluation, Shanghai AI Laboratory, School of Integrated Circuit Design, Shanghai Jiao Tong University, John Hopcroft Center, Shanghai Jiao Tong University
    - 📅 Date: December 12, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Desktop]
    - 🔑 Key: [benchmark], [dataset], [EDA], [multimodal LLM]
...
- [AFRAgent : An Adaptive Feature Renormalization Based High Resolution Aware GUI agent](https://arxiv.org/abs/2512.00846)
    ...
    - 🏛️ Institutions: Media and Data Science Research, Adobe
    - 📅 Date: November 30, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [multimodal LLM], [GUI grounding], [smartphone automation], [vision-language model]
...
- [LegalWebAgent: Empowering Access to Justice via LLM-Based Web Agents](https://arxiv.org/abs/2512.04105)
    ...
    - 🏛️ Institutions: Cyberjustice Laboratory, Faculty of Law, University of Montreal
    - 📅 Date: November 28, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [LLM agent], [multimodal], [benchmark], [legal domain], [form filling]
...
- [In-Browser LLM-Guided Fuzzing for Real-Time Prompt Injection Testing in Agentic AI Browsers](https://arxiv.org/abs/2510.13543)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [browser agent], [security], [prompt injection], [fuzzing], [attack]
...
- [WebRouter: Query-specific Router via Variational Information Bottleneck for Cost-sensitive Web Agent](https://arxiv.org/abs/2510.11221)
    ...
    - 🏛️ Institutions: College of Artificial Intelligence, Nanjing University of Aeronautics and Astronautics, Hong Kong Baptist University, SKLCCSE Lab, Beihang University, Pengcheng Laboratory
    - 📅 Date: October 13, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [LLM routing], [cost efficiency], [information bottleneck], [WebVoyager], [LLM ensemble]
...
- [WARC-Bench: Web Archive Based Benchmark for GUI Subtask Executions](https://arxiv.org/abs/2510.09872)
    ...
    - 📑 Publisher: ICLR 2026 (Poster)
    - 💻 Env: [Web]
    - 🔑 Key: [benchmark], [GUI subtask], [web archive], [RLVR], [WARC-Bench]
    - 📖 TLDR: WARC-Bench is a sandboxed benchmark of 438 short-horizon web subtasks built from realistic archived webpages using WARC files, targeting interactions like date picking and container scrolling that broader benchmarks often under-measure. The paper shows these subtasks remain hard for leading computer-use models and that RL with verifiable rewards improves open models beyond supervised fine-tuning alone.
...
- [From Imperative to Declarative: Towards LLM-friendly OS Interfaces for Boosted Computer-Use Agents](https://arxiv.org/abs/2510.04607)
    ...
    - 🏛️ Institutions: Key Laboratory of System Software, Institute of Software, Chinese Academy of Sciences, University of Chinese Academy of Sciences
    - 📅 Date: October 06, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Desktop]
    - 🔑 Key: [framework], [OS interface], [abstraction]
...
- [JEF-Hinter: Leveraging Offline Knowledge for Improving Web Agents Adaptation](https://arxiv.org/abs/2510.04373)
    ...
    - 🏛️ Institutions: ServiceNow Research, Mila - Quebec AI Institute, Université de Montréal, Dalhousie University, Polytechnique Montréal, Canada CIFAR AI Chair
    - 📅 Date: October 05, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [LLM agent], [offline learning], [hint generation], [trajectory distillation], [benchmark]
...
- [FocusAgent: Simple Yet Effective Ways of Trimming the Large Context of Web Agents](https://arxiv.org/abs/2510.03204)
    ...
    - 🏛️ Institutions: LIRIS - CNRS, INSA Lyon, Universite Claude Bernard Lyon 1, Esker, ServiceNow Research, Mila - Quebec AI Institute, McGill University, Polytechnique Montréal
...
- [PAL-UI: Planning with Active Look-back for Vision-Based GUI Agents](https://arxiv.org/abs/2510.00413)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile], [Web]
    - 🔑 Key: [active look-back], [memory retrieval], [mobile navigation], [web navigation], [PAL-UI]
    - 📖 TLDR: PAL-UI equips vision-based GUI agents with active memory retrieval rather than relying only on truncated history or coarse summaries. It combines observation-level and action-level summaries with a retrieval tool that recalls specific historical screenshots during planning, improving long-horizon mobile navigation and transferring well to web navigation without extra training.
...
- [Efficient Multi-turn RL for GUI Agents via Decoupled Training and Adaptive Data Curation](https://arxiv.org/abs/2509.23866)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Desktop], [Mobile]
    - 🔑 Key: [reinforcement learning], [decoupled training], [adaptive data curation], [asynchronous system], [DART]
    - 📖 TLDR: DART is a decoupled asynchronous RL training framework for GUI agents that addresses two concrete bottlenecks in multi-turn learning: slow rollout in interactive environments and scarce high-quality trajectories. It separates rollout and training into four non-blocking modules and adds adaptive data-curation mechanisms such as difficulty-aware rollout allocation, high-entropy step selection, and policy-mismatch correction, yielding large efficiency gains and stronger OSWorld performance.
...
- [MobileRL: Online Agentic Reinforcement Learning for Mobile GUI Agents](https://arxiv.org/abs/2509.18119)
    ...
    - 📖 TLDR: MobileRL is an online reinforcement learning framework for mobile GUI agents whose core algorithm, ADAGRPO, combines difficulty-adaptive positive replay, failure curriculum filtering, and shortest-path reward adjustment for multi-turn tasks. Applied to open vision-language models, it improves sample efficiency and reaches state-of-the-art success rates on AndroidWorld and AndroidLab.
...
- [MAS-Bench: A Unified Benchmark for Shortcut-Augmented Hybrid Mobile GUI Agents](https://arxiv.org/abs/2509.06477)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [benchmark], [hybrid agent], [shortcut]
...
- [A Multimodal GUI Architecture for Interfacing with LLM-Based Conversational Assistants](https://arxiv.org/abs/2510.06223)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Desktop]
    - 🔑 Key: [MCP], [framework], [natural language interface], [desktop automation]
...
- [VeriWeb: Verifiable Long-Chain Web Benchmark for Agentic Information-Seeking](https://arxiv.org/abs/2508.04026)
    ...
    - 🏛️ Institutions: NTU, Zhejiang University, University of Tokyo, Shanghai AI Lab, Google DeepMind, University of Alberta
    - 📅 Date: August 06, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [dataset], [benchmark], [information seeking], [long-horizon task], [subtask verification], [VeriWeb]
    - 📖 TLDR: VeriWeb is a long-horizon web benchmark for agentic information-seeking, built around decomposed subtasks with verifiable intermediate answers rather than outcome-only scoring. It contains 302 human-annotated tasks across five domains and exposes large performance gaps for current web agents on breadth- and depth-heavy search tasks.
...
- [SEAgent: Self-Evolving Computer Use Agent with Autonomous Learning from Experience](https://arxiv.org/abs/2508.04700)
    ...
    - 🏛️ Institutions: Shanghai Jiao Tong University, Shanghai Artificial Intelligence Laboratory, The Chinese University of Hong Kong
    - 📅 Date: August 06, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Desktop]
    - 🔑 Key: [self-evolving], [experiential learning], [framework], [exploration]
...
- [Web-CogReasoner: Towards Knowledge-Induced Cognitive Reasoning for Web Agents](https://arxiv.org/abs/2508.01858)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [cognitive reasoning], [chain-of-thought], [knowledge framework], [benchmark], [dataset]
...
- [BIMgent: Towards Autonomous Building Modeling via Computer-use Agents](https://arxiv.org/abs/2506.07217)
    ...
    - 🏛️ Institutions: Chair of Computing in Civil and Building Engineering, Technical University of Munich, TUM Georg Nemetschek Institute
    - 📅 Date: June 08, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Desktop]
    - 🔑 Key: [framework], [domain-specific], [desktop automation]
...
- [LLM-Guided Scenario-based GUI Testing](https://arxiv.org/abs/2506.05079)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [LLM], [GUI testing], [multi-agent], [framework], [benchmark]
...
- [Go-Browse: Training Web Agents with Structured Exploration](https://arxiv.org/abs/2506.03533)
    ...
    - 📑 Publisher: ICLR 2026 (Poster)
    - 💻 Env: [Web]
    - 🔑 Key: [dataset], [structured exploration], [task generation], [WebArena], [go-browse]
...
- [Open CaptchaWorld: A Comprehensive Web-based Platform for Testing and Benchmarking Multimodal LLM Agents](https://arxiv.org/abs/2505.24878)
    ...
    - 📑 Publisher: NeurIPS 2025 (Poster)
    - 💻 Env: [Web]
    - 🔑 Key: [benchmark], [multimodal agent], [CAPTCHA], [reasoning], [open CaptchaWorld]
...
- [Unlocking Smarter Device Control: Foresighted Planning with a World Model-Driven Code Execution Approach](https://arxiv.org/abs/2505.16422)
    ...
    - 📖 TLDR: Improves multi-step mobile device control by building a text-based world model at task start and expressing plans as executable Python code rather than reactive one-step actions. FPWC then self-verifies through zoomed visual checks and iteratively refines both plan and world model, yielding large gains on simulated and real-device single- and cross-app tasks.
...
- [ReGUIDE: Data Efficient GUI Grounding via Spatial Reasoning and Search](https://arxiv.org/abs/2505.15259)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [GUI grounding], [spatial reasoning], [data efficiency], [framework]
...
- [Efficient Agent Training for Computer Use](https://arxiv.org/abs/2505.13909)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Desktop]
    - 🔑 Key: [training], [data efficiency], [synthetic data], [framework]
...
- [Infogent: An Agent-Based Framework for Web Information Aggregation](https://aclanthology.org/2025.findings-naacl.318/)
    ...
    - 💻 Env: [Web]
    - 🔑 Key: [framework], [information aggregation], [browser navigation], [AssistantBench], [infogent]
...
- [UFO2: The Desktop AgentOS](https://arxiv.org/abs/2504.14603)
    ...
    - 🏛️ Institutions: Microsoft, ZJU-UIUC Institute, Nanjing University, Peking University
    - 📅 Date: April 20, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Desktop]
    - 🔑 Key: [framework], [hybrid control], [multi-agent], [speculative execution], [UFO2]
    - 📖 TLDR: Presents UFO2 as a Windows AgentOS that moves beyond single-agent desktop control by combining a coordinating HostAgent with specialized AppAgents. Its distinctive ideas are hybrid UI perception, speculative multi-action execution, and a system-level substrate for robust cross-application desktop automation.
...
- [REAL: Benchmarking Autonomous Agents on Deterministic Simulations of Real Websites](https://arxiv.org/abs/2504.11543)
    ...
    - 📖 TLDR: Builds deterministic simulations of 11 real websites so autonomous web agents can be evaluated safely and reproducibly without losing realistic task structure. REAL pairs 112 multi-turn tasks with a hybrid evaluation framework that combines programmatic state checks and rubric-guided LLM judgments, and shows frontier agents still top out around 41% success.
...
- [AgentA/B: Automated and Scalable Web A/BTesting with Interactive LLM Agents](https://arxiv.org/abs/2504.09723)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [A/B testing], [LLM agent], [user simulation], [e-commerce], [framework]
...
- [MobileA3gent: Training Mobile GUI Agents Using Decentralized Self-Sourced Data from Diverse Users](https://arxiv.org/abs/2502.02982)
    ...
    - 🏛️ Institutions: Zhejiang University, Shanghai Jiao Tong University, Shanghai AI Laboratory, Multi-Agent Governance & Intelligence Crew (MAGIC)
    - 📅 Date: February 05, 2025
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [framework], [auto-annotation], [federated learning], [privacy], [non-IID], [adapted aggregation], [MobileA3gent]
    - 📖 TLDR: MobileA3gent studies how to train mobile agents from decentralized user data rather than costly centralized annotation. It combines automatic instruction/data collection from routine phone usage with federated VLM training under non-IID user distributions, reaching performance comparable to centralized human-annotated training at a small fraction of the cost.
...
- [AdaptAgent: Adapting Multimodal Web Agents with Few-Shot Learning from Human Demonstrations](https://aclanthology.org/2025.acl-long.1008/)
    ...
    - 📑 Publisher: ACL 2025
    - 💻 Env: [Web]
    - 🔑 Key: [framework], [few-shot adaptation], [human demonstrations], [meta-learning], [AdaptAgent]
...
- [From Context to Action: Analysis of the Impact of State Representation and Context on the Generalization of Multi-Turn Web Navigation Agents](https://arxiv.org/abs/2410.23555)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [context management], [state representation], [generalization], [multi-turn navigation], [CWA]
    - 📖 TLDR: Analyzes how state representation and interaction context affect the generalization of multi-turn conversational web agents. The paper shows that better choices for webpage representation and history tracking materially improve out-of-distribution performance on unseen websites, categories, and locations.
...
- [Auto-Intent: Automated Intent Discovery and Self-Exploration for Large Language Model Web Agents](https://arxiv.org/abs/2410.22552)
    ...
    - 💻 Env: [Web]
    - 🔑 Key: [auto-intent], [intent discovery], [self-exploration], [web navigation]
...
- [Agent S: An Open Agentic Framework that Uses Computers Like a Human](https://proceedings.iclr.cc/paper_files/paper/2025/hash/ab87cdfe514bf8f9c07e5e7aa247f55f-Abstract-Conference.html)
    ...
    - 📖 TLDR: Presents Agent S, an open computer-use framework that combines an Agent-Computer Interface with experience-augmented hierarchical planning. The system improves desktop task performance on OSWorld and is designed to transfer across operating systems rather than overfitting to a single environment.
...
- [AXIS: Efficient Human-Agent-Computer Interaction with API-First LLM-Based Agents](https://aclanthology.org/2025.acl-long.381/)
    ...
    - 📖 TLDR: Proposes AXIS, an API-first agent framework that prioritizes API actions over direct UI manipulation to reduce latency and improve reliability. On Microsoft Word tasks it cuts completion time and cognitive workload substantially while maintaining near-human accuracy, and it motivates a broader Human-Agent-Computer Interaction design framework.
...
- [Windows Agent Arena: Evaluating Multi-Modal OS Agents at Scale](https://proceedings.mlr.press/v267/bonatti25a.html)
    ...
    - 📑 Publisher: ICML 2025 (Poster)
    - 💻 Env: [Desktop]
    - 🔑 Key: [benchmark], [Windows Agent Arena], [WAA], [Navi], [desktop agent evaluation]
    - 📖 TLDR: Introduces Windows Agent Arena (WAA), a scalable benchmark platform for evaluating multimodal agents in a realistic Windows environment. The paper also presents Navi as a baseline agent and uses it to show how the platform can support large-scale desktop-agent evaluation.
...
- [MobileExperts: A Dynamic Tool-Enabled Agent Team in Mobile Devices](https://arxiv.org/abs/2407.03913)
    ...
    - 📖 TLDR: Proposes MobileExperts, a mobile multi-agent framework that dynamically assembles tool-enabled expert agents according to the user request. The system combines expert discovery, tool formulation, and double-layer planning to lower reasoning costs while improving task execution on mobile devices.
...
- [Seeing is Believing: Vision-driven Non-crash Functional Bug Detection for Mobile Apps](https://arxiv.org/abs/2407.03037)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [framework], [GUI testing], [non-crash bug detection], [Trident], [mobile app testing]
    - 📖 TLDR: Introduces Trident, a vision-driven multi-agent framework for detecting non-crash functional bugs in mobile apps from screenshots and execution history. The method uses multimodal reasoning over page semantics and transition logic to catch bugs that crash-oriented testing pipelines often miss.
...
- [E-ANT: A Large-Scale Dataset for Efficient Automatic GUI NavigaTion](https://arxiv.org/abs/2406.14250)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [dataset], [benchmark], [E-ANT], [Chinese GUI navigation]
    - 📖 TLDR: Introduces E-ANT, a large-scale Chinese mobile GUI navigation dataset with nearly 40,000 real human traces across more than 5,000 tiny apps. It is designed to support both evaluation and training of mobile GUI agents with high-quality screenshots and annotations.
...
- [VLM Agents Generate Their Own Memories: Distilling Experience into Embodied Programs of Thought](https://openreview.net/forum?id=5G7MRfPngt)
    ...
    - 💻 Env: [Desktop]
    - 🔑 Key: [framework], [memory], [in-context learning], [ICAL], [programs of thought]
    - 📖 TLDR: Introduces In-Context Abstraction Learning (ICAL), a method for turning sub-optimal demonstrations and feedback into reusable multimodal memories for VLM agents. These abstracted "programs of thought" improve in-context decision-making on embodied computer-control tasks.
...
- [Identifying User Goals from UI Trajectories](https://arxiv.org/abs/2406.14314)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile], [Web]
    - 🔑 Key: [goal identification], [intent identification], [evaluation metric], [UI trajectories]
    - 📖 TLDR: Introduces the task of inferring a user's goal from observed UI trajectories and proposes an environment-aware metric for judging whether two intent descriptions are equivalent. The paper benchmarks both humans and frontier models on Android and web interaction datasets and finds a sizable gap to human performance.
...
- [GUI-World: A Video Benchmark and Dataset for Multimodal GUI-oriented Understanding](https://arxiv.org/abs/2406.10819)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Desktop], [Web]
    - 🔑 Key: [dataset], [benchmark], [video GUI], [dynamic GUI understanding], [GUI-World]
    - 📖 TLDR: Introduces GUI-World, a video-centric benchmark for GUI-oriented multimodal understanding that moves beyond static screenshots to dynamic content, multi-step interactions, and multi-window settings. The results show that strong MLLMs still struggle with temporal reasoning in GUI videos.
...
- [GUIOdyssey: A Comprehensive Dataset for Cross-App GUI Navigation on Mobile Devices](https://arxiv.org/abs/2406.08451)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [dataset], [OdysseyAgent], [cross-app navigation], [mobile navigation], [GUIOdyssey]
    - 📖 TLDR: Introduces GUIOdyssey, a mobile dataset for long-horizon cross-app navigation with thousands of episodes across six devices and more than 200 apps. The paper also proposes OdysseyAgent, which uses history resampling to better handle long multi-app trajectories.
...
- [Practical, Automated Scenario-based Mobile App Testing](https://arxiv.org/abs/2406.08340)
    ...
    - 💻 Env: [Mobile]
    - 🔑 Key: [framework], [ScenTest], [event knowledge graph], [scenario-based testing]
    - 📖 TLDR: Introduces ScenTest, a mobile app testing framework that uses event knowledge graphs and GUI image understanding to generate business-logic-aware scenarios instead of coverage-only tests. The goal is to better imitate how human testers reason about end-to-end app behavior.
...
- [MobileAgentBench: An Efficient and User-Friendly Benchmark for Mobile LLM Agents](https://arxiv.org/abs/2406.08184)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [benchmark], [MobileAgentBench], [mobile agent evaluation]
    - 📖 TLDR: Introduces MobileAgentBench, a practical benchmark for evaluating LLM-based mobile agents across 100 tasks on 10 open-source apps. The benchmark is designed to reduce manual testing burden while making agent comparisons more reproducible and user-friendly.
...
- [On the Effects of Data Scale on UI Control Agents](https://proceedings.neurips.cc/paper_files/paper/2024/hash/a79f3ef3b445fd4659f44648f7ea8ffd-Abstract-Datasets_and_Benchmarks_Track.html)
    ...
    - 📑 Publisher: NeurIPS 2024 Datasets and Benchmarks Track
    - 💻 Env: [Mobile]
    - 🔑 Key: [dataset], [AndroidControl], [data scaling], [fine-tuning]
    - 📖 TLDR: Studies how UI-control agent performance scales with more fine-tuning data and releases AndroidControl, a dataset of over 15K demonstrations across 833 Android apps. The paper shows strong in-domain scaling trends while highlighting that out-of-domain generalization remains harder.
...
- [WebSuite: Systematically Evaluating Why Web Agents Fail](https://arxiv.org/abs/2406.01623)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [benchmark], [failure analysis], [taxonomy], [WebSuite], [task disaggregation]
    - 📖 TLDR: Introduces WebSuite, a diagnostic benchmark for understanding why web agents fail rather than only whether they fail. It organizes web behavior into a taxonomy of actions and builds both atomic and end-to-end tasks so failures can be traced back to specific action categories.
...
- [MMInA: Benchmarking Multihop Multimodal Internet Agents](https://aclanthology.org/2025.findings-acl.703/)
    ...
    - 📑 Publisher: Findings of ACL 2025
    - 💻 Env: [Web]
    - 🔑 Key: [benchmark], [MMInA], [multihop web tasks], [multimodal web agents], [memory augmentation]
    - 📖 TLDR: Introduces MMInA, a benchmark of 1,050 multihop multimodal Internet tasks on evolving real-world websites. The paper emphasizes long-range reasoning across multiple sites, proposes hop-level evaluation in addition to end-task success, and shows that replay-based memory augmentation helps current agents.
...
- [Tur[k]ingBench: A Challenge Benchmark for Web Agents](https://aclanthology.org/2025.naacl-long.188/)
    ...
    - 📑 Publisher: NAACL 2025
    - 💻 Env: [Web]
    - 🔑 Key: [benchmark], [dataset], [Tur[k], [crowdsourcing web pages], [multimodal web tasks], [evaluation framework]
    - 📖 TLDR: Builds a web-agent benchmark from real crowdsourcing HTML pages rather than synthetic sites, yielding 158 task templates and 32.2K instances with multimodal context. The accompanying evaluation framework shows current language-, vision-, and layout-based models are still far from reliably handling these realistic web interactions.
...
- [Android in the Zoo: Chain-of-Action-Thought for GUI Agents](https://aclanthology.org/2024.findings-emnlp.702/)
    ...
    - 📑 Publisher: Findings of EMNLP 2024
    - 💻 Env: [Mobile]
    - 🔑 Key: [framework], [dataset], [CoAT], [AitZ], [mobile GUI agents], [action rationale]
...
- [WebVLN: Vision-and-Language Navigation on Websites](https://arxiv.org/abs/2312.15820)
    ...
    - 📑 Publisher: AAAI 2024
    - 💻 Env: [Web]
    - 🔑 Key: [task], [dataset], [WebVLN-v1], [WebVLN-Net], [HTML grounding], [vision-language navigation]
    - 📖 TLDR: Extends vision-language navigation to websites by framing browsing as question-driven navigation over rendered pages plus underlying HTML. The paper introduces the WebVLN task, the WebVLN-v1 dataset, and a Website-aware VLN Network that outperforms prior VLN and web-navigation baselines.
...
- [AppAgent: Multimodal Agents as Smartphone Users](https://doi.org/10.1145/3706598.3713600)
    ...
    - 📑 Publisher: CHI 2025
    - 💻 Env: [Mobile]
    - 🔑 Key: [framework], [AppAgent], [knowledge base], [autonomous exploration], [demonstration learning], [mobile automation]
    - 📖 TLDR: Builds a smartphone-use agent that acts through a simple tap-and-swipe action space without requiring backend access to the app. AppAgent learns new applications either through autonomous exploration or human demonstrations, stores that experience in a knowledge base, and then uses it to execute over 50 tasks across 10 apps.
...
- [UI Layout Generation with LLMs Guided by UI Grammar](https://arxiv.org/abs/2310.15455)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Mobile]
    - 🔑 Key: [position paper], [UI grammar], [UI layout generation], [controllable generation]
    - 📖 TLDR: A position paper on using LLMs for mobile UI layout generation, centered on representing screens with a UI grammar. Its contribution is mainly conceptual: grammar-based structure can make LLM-driven UI generation more controllable and explainable than plain prompt-only generation.
...
- [Android in the Wild: A Large-Scale Dataset for Android Device Control](https://proceedings.neurips.cc/paper_files/paper/2023/hash/bbbb6308b402fe909c39dd29950c32e0-Abstract-Datasets_and_Benchmarks.html)
    ...
    - 💻 Env: [Mobile]
    - 🔑 Key: [dataset], [benchmark], [AITW], [device control], [gesture-based actions]
    - 📖 TLDR: Introduces Android in the Wild, a large-scale dataset of human-labeled Android device-control episodes with natural-language commands and touch actions. It became one of the central training and evaluation resources for mobile agents because it stresses robustness across apps, tasks, and gesture types.
